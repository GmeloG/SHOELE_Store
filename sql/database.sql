...
-- Apagar base de dados anterior se existir e recriar
CREATE DATABASE IF NOT EXISTS sneakerstock
...
CREATE TABLE products (
    ...
    brand      VARCHAR(100)   NOT NULL COMMENT 'Marca da sapatilha',
    model      VARCHAR(100)   NOT NULL COMMENT 'Modelo da sapatilha',
    description TEXT           NULL     COMMENT 'Descrição detalhada',
    base_price DECIMAL(10,2)  NOT NULL DEFAULT 0.00 COMMENT 'Preço base',
    image      VARCHAR(255)   NULL     COMMENT 'Caminho da imagem',
    active     TINYINT(1)     NOT NULL DEFAULT 1 COMMENT '1=ativo, 0=inativo',
    created_at TIMESTAMP      NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP      NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- ------------------------------------------------------------
-- Tabela: product_variants (stock por produto + cor + tamanho)
-- ------------------------------------------------------------
DROP TABLE IF EXISTS product_variants;
CREATE TABLE product_variants (
    id         INT AUTO_INCREMENT PRIMARY KEY,
    product_id INT            NOT NULL COMMENT 'Referência ao produto',
    color      VARCHAR(50)    NOT NULL COMMENT 'Cor da variante',
    size       VARCHAR(10)    NOT NULL COMMENT 'Tamanho (EU)',
    price      DECIMAL(10,2)  NULL     COMMENT 'Preço específico (sobrepõe base_price)',
    stock      INT            NOT NULL DEFAULT 0 COMMENT 'Quantidade em stock',
    created_at TIMESTAMP      NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP      NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE orders (
    ...
    user_id     INT            NULL     COMMENT 'Utilizador registado (null = convidado)',
    status      ENUM('encomendada','em_armazem','entregue','cancelada') NOT NULL DEFAULT 'encomendada',
...
-- ------------------------------------------------------------
-- Tabela: sales (vendas no POS/loja física)
-- ------------------------------------------------------------
...
CREATE TABLE stock_movements (
    ...
    reference_id   INT            NULL     COMMENT 'ID da encomenda ou venda',
...
-- Produtos
INSERT INTO products (brand, model, description, base_price, image, active) VALUES
('New Balance', '530',    'Inspirada nos anos 90, a NB 530 combina tecidos premium com a tecnologia ABZORB para absorção de impacto. Um ícone atemporal com silhueta elegante e estilo desportivo.', 109.99, NULL, 1),
('New Balance', '574',    'Uma das sapatilhas mais icónicas da New Balance. A 574 apresenta um design clássico com tecnologia ENCAP na sola, combinando estilo retro com conforto moderno.', 89.99,  NULL, 1),
('New Balance', '327',    'Inspirada nos anos 70, a 327 destaca-se pela sola ondulada única e pelo design minimalista. Perfeita para quem procura um look diferente e irreverente.', 99.99,  NULL, 1),
('New Balance', '2002R',  'Sapatilha premium com tecnologia ABZORB SBS e N-ergy para máximo conforto. Design sofisticado que combina materiais de alta qualidade com estética moderna.', 149.99, NULL, 1),
('Nike',        'Air Force 1', 'Uma lenda do basquetebol transformada em ícone de moda. A Nike Air Force 1 apresenta a tecnologia Air na sola e um design limpo que nunca passa de moda.', 119.99, NULL, 1),
('Nike',        'Air Max 90',  'Com a janela Air visível na sola traseira, a Air Max 90 é uma das sapatilhas mais reconhecíveis do mundo. Conforto excepcional com estética bold dos anos 90.', 129.99, NULL, 1),
('Adidas',      'Samba',       'A lendária sapatilha de futsal dos anos 50 reinventada como ícone de streetwear. A Adidas Samba tem uma silhueta inconfundível com detalhes em camurça.', 99.99,  NULL, 1),
('Adidas',      'Gazelle',     'Criada em 1966, a Adidas Gazelle é uma das sapatilhas mais vendidas de sempre. Design minimalista em camurça com tiras de borracha clássicas.', 89.99,  NULL, 1),
('Puma',        'Suede Classic', 'A Puma Suede é uma das sapatilhas mais emblemáticas da história do desporto. Desde 1968, o seu design simples em camurça é sinónimo de estilo urbano.', 79.99,  NULL, 1),
('Vans',        'Old Skool',   'O primeiro calçado da Vans a exibir a famosa Jazz Stripe. A Old Skool combina cabedal de lona e camurça com sola Waffle para durabilidade e aderência.', 74.99,  NULL, 1);
...
(1, 3, 1, 109.99),
(2, 45, 1, 119.99), (2, 62, 1, 99.99),
(3, 21, 1, 89.99);

-- Registo de movimentos de stock para as encomendas acima
